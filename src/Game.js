...
class Game extends React.Component {
    ...
    render() {
        ...
        return (
            <div>
                <div className ="gen">Generation:{this.state.generation/30} </div>
                <div className="Board"
                ...
                <div className="controls">
                    ...
                    <p>2. Any live cell with two or three live neighbors lives on.</p>
                    <p>3. Any live cell with more than three live neighbors dies.</p>
                    <p>4. Any dead cell with three neighbors comes back alive.</p>
                </div>
            </div>
        )
    }
